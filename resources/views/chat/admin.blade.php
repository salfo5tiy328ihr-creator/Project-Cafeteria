...
<div style="margin-bottom: 25px;">
    <h2 style="font-weight: 700; color: #1f2937; display: flex; align-items: center; gap: 10px;">
        <i class="fas fa-robot" style="color: #6366f1;"></i> AI Admin Assistant
    </h2>
    <p style="color: #6b7280; margin-top: 5px;">Ask me anything about your cafeteria's data.</p>
</div>
...
<div class="card" style="max-width: 900px;">
    <div class="card-body" style="padding: 0;">
        <div id="chatBox" style="height: 500px; overflow-y: auto; padding: 25px; background: #f9fafb;">
            <div style="display: flex; gap: 12px; margin-bottom: 20px;">
                ...
                <div style="background: white; padding: 12px 18px; border-radius: 15px 15px 15px 5px; max-width: 70%; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                    Hello Admin! 👋 Ask me:<br>
                    • "How many orders today?"<br>
                    • "What's the total sales?"<br>
                    • "Show me top selling items"<br>
                    • "Which products have low stock?"<br>
                    • "How many customers do we have?"<br>
                    • "Which category has the most items?"<br>
                    • "Show me the most popular meals"<br>
        ...
        <div style="padding: 20px; border-top: 1px solid #e5e7eb; display: flex; gap: 10px; background: white;">
            <input type="text" id="messageInput" placeholder="Type your question..." style="flex: 1; padding: 14px 18px; border: 2px solid #e5e7eb; border-radius: 12px; font-family: 'Cairo'; outline: none;" onkeypress="if(event.key==='Enter') sendMessage()">
...
function addMessage(text, type) {
    ...
    const icon = type === 'user' 
        ? '<div style="width: 40px; height: 40px; background: #10b981; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; flex-shrink: 0;"><i class="fas fa-user-shield"></i></div>'
    ...
    div.innerHTML = icon + '<div style="' + bubble + ' white-space: pre-line;">' + text + '</div>';
