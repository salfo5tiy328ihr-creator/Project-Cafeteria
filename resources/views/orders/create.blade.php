...
<head>
    ...
    <title>Add Order - Cafeteria</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        @media (max-width: 600px) {
            .item-row { grid-template-columns: 1fr 80px 80px 40px; }
        }
        .btn-add-item {
        ...
        .btn-add-item:hover { background: rgba(99,102,241,.2); }
        .btn-remove {
...
<div class="form-wrapper">
    <div class="form-card">
        ...
        <div class="form-header">
            ...
            <h2>Add New Order</h2>
            <p>Create a new cafeteria order</p>
        </div>
        ...
        <form action="{{ route('orders.store') }}" method="POST" id="orderForm">
            ...
            <button type="submit" class="btn-submit">
                <i class="fa-solid fa-check"></i> Save Order
            </button>
